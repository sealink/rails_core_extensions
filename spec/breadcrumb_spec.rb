  ...
  context '#breadcrumbs (* = link)' do
    ...
    context 'for a new record' do
      ...
      it 'should breadcrumb: *Users / New' do
        ...
        expected = %q(<ul class="breadcrumb"><li><a href="/users">Users</a></li><li class="active">New</li></ul>)
    ...
    context 'for a existing record' do
      ...
      context 'when editing' do
        ...
        it 'should breadcrumb: *Users / *Alice / Edit' do
          allow(subject).to receive(:link_to).with('Users', '/users') { '<a href="/users">Users</a>'.html_safe }
          allow(subject).to receive(:link_to).with('Alice', user) { '<a href="/users/1">Alice</a>'.html_safe }
          result = subject.breadcrumbs(user)
          expect(result).to be_html_safe
          expected = %q(<ul class="breadcrumb"><li><a href="/users">Users</a></li><li><a href="/users/1">Alice</a></li><li class="active">Edit</li></ul>)
          expect(result).to eq expected
        end
      end
      ...
      context 'when showing' do
        ...
        it 'should breadcrumb: *Users / Alice' do
          result = subject.breadcrumbs(user)
          expect(result).to be_html_safe
          expected = %q(<ul class="breadcrumb"><li><a href="/users">Users</a></li><li>Alice</li></ul>)
          expect(result).to eq expected
        end
      end
    end
